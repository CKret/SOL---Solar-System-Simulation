...
**1. Authoritative bodies** — imports the curated body set (planets, moons, dwarf planets, comets, Voyager probes) from JPL Horizons and the JPL Small-Body Database:
